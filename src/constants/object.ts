...
export const CDP_PACKAGE_ID =
  "0x047ea5037499b28cc3e51d9d92af2962679cb5453fcec710dd9db36af0e2100e";
...
export const VAULT_MAP: Record<COLLATERAL_COIN, VaultObjectInfo> = {
  ...
  stIOTA: {
    priceAggregater: {
      objectId:
        "0xad71067ef6b3724bf9db065e40f5e34ebf1252e203a964b04b22cef0b953ebff",
      mutable: true,
      initialSharedVersion: 237544292,
    },
    vault: {
      objectId:
        "0xee754802462d920e877d6c05b968a449c35399d4b7fcaadefae17dd0007458a3",
      mutable: true,
