...
export const CONFIG: Record<"mainnet" | "testnet", ConfigType> = {
  mainnet: {
    ...
    ORACLE_PACKAGE_ID:
      "0x7eebbee92f64ba2912bdbfba1864a362c463879fc5b3eacc735c1dcb255cc2cf",
    CDP_PACKAGE_ID:
      "0xb0ca01917f84a07774397395467fc2d56de377fab9d603cb79b82f062d1f6e9a",
    STABILITY_POOL_PACKAGE_ID:
      "0xe50fa492446245d9dd4bc61641a4ab2e72cd1276703d6ae8e41377a046b0929b",
    ...
    VAULT_REWARDER_REGISTRY_OBJ: {
      objectId:
        "0x453e1e9deb1873b3a79a9e60ce0c7ffe06b28387f4b1d9f8afaf7d4c8e1c7462",
      initialSharedVersion: 196734342,
      mutable: false,
    },
    POOL_REWARDER_REGISTRY_OBJ: {
      objectId:
        "0x7e63835296d4585c98c29afcd9cb45fe96da04cf09c8235b26135ecac245515c",
      initialSharedVersion: 196734342,
      mutable: false,
    },
    PYTH_STATE_ID:
    ...
    STABILITY_POOL_REWARDERS: [
      {
        objectId:
          "0xd34d8de1558ebd521382a92fa4824bb00cf97cdfaba2a0a9843f2e5a03b4e430",
        mutable: true,
    ...
    VAULT_MAP: {
      ...
      stIOTA: {
        ...
        rewarders: [
          {
            objectId:
              "0x5752324b10b19792528af301bd65128f22dc30562e8a67b9e33da49bd7aff1d9",
