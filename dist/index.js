...
var VirtueClient = class {
  ...
  checkResponseForStabilityPool(response) {
    ...
    (_nullishCoalesce(STABILITY_POOL_REWARDERS, () => ( []))).map((rewarder) => {
      const rewardType = COIN_TYPES[rewarder.rewardSymbol];
      this.transaction.moveCall({
